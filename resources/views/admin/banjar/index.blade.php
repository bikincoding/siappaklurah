...
<div class="card">
    <div class="card-header warna-pns">{{ __('Data Lingkungan') }}</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-primary"
                                    href="{{ route('banjars.edit', $banjar->id) }}">Edit</a>

                                <!-- Tombol yang memicu modal -->
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal{{ $banjar->id }}">
                                    Delete
                                </button>

                                <!-- Modal Konfirmasi Delete -->
                                <div class="modal fade" id="deleteModal{{ $banjar->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('banjars.destroy', $banjar->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
