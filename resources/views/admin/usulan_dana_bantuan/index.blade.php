...
<div class="card">
    ...
    <div class="card-body">
        <div class="card mb-3">
            <div class="card-body">
                <a class="btn btn-sm btn-success" href="{{ route('cetak_laporan_usulan_dana_bantuan') }}"
                    target="_blank">Cetak
                    Laporan</a>
                <a class="btn btn-sm btn-primary" href="{{ route('export.xlsx') }}">Download XLSX</a>
            </div>
        </div>
        <!-- Pesan Sukses -->
            ...
            <div class="card-body table-responsive">
                <table class=" table table-sm table-striped table-bordered mt-3 mb-3 table-untuk-data">
                    <thead class="table-bordered ">
                        <tr>
                            <th>No</th>
                            <th style="min-width: 200px; max-width: 500px;">Nama</th>
                            <th>KTP</th>
                            <th>SPK</th>
                            <!-- <th>Alamat</th> -->
                            <th>Usulan</th>
                            <th>Keterangan</th>
                            <th style="min-width: 100px; max-width: 500px;">Tgl Pengajuan</th>
                            <th style="min-width: 200px; max-width: 500px;">Lingkungan</th>
                            <th>Status</th>

                            <th style="min-width: 80px; max-width: 500px;">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
