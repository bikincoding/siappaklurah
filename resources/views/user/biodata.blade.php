...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('kepala_lingkungans.update_biodata', $kepala_lingkungan->id) }}" method="post"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-2">
                        ...
                        <img src="{{ asset('storage/foto_kepala_lingkungan/'.$kepala_lingkungan->foto) }}"
                            alt="current-photo" width="100"><br>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" id="nama_kepala_lingkungan"
                            name="nama_kepala_lingkungan"
                            value="{{ old('nama_kepala_lingkungan', $kepala_lingkungan->nama_kepala_lingkungan) }}"
                            required>
                    </div>
                    <div class="form-group mb-2">
                        <label for="alamat">Alamat:</label>
                        <textarea class="form-control" id="alamat" name="alamat"
                            required>{{ old('alamat', $kepala_lingkungan->alamat) }}</textarea>
                    </div>
                    <div class="form-group mb-2">
                        <label for="id_banjars">Lingkungan: </label>
                        {{ $kepala_lingkungan->banjar->nama_banjar }}
                    </div>
                    <div class="form-group mb-2">
                        <label for="telepon">Telepon:</label>
                        <input type="text" class="form-control" id="telepon" name="telepon"
                            value="{{ old('telepon', $kepala_lingkungan->telepon) }}" required>
                    </div>
                </div>
            </div>
